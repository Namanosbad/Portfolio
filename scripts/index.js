...
const translations = {
  pt: {
    ...
    'projects.invoiceAPI.description': 'A InvoiceAPI é uma API REST para gerenciamento completo de faturas em cenários financeiros. O projeto centraliza regras de negócio fora dos controllers, calcula itens e total automaticamente e utiliza arquitetura em camadas para garantir manutenção, escalabilidade e previsibilidade no domínio.',
  ...
  en: {
    ...
    'projects.invoiceAPI.title': 'InvoiceAPI 💸📄',
    'projects.invoiceAPI.description': 'InvoiceAPI is a REST API for full invoice lifecycle management in financial scenarios. The project centralizes business rules outside controllers, automatically calculates item values and invoice totals, and follows a layered architecture to ensure maintainability, scalability, and predictable domain behavior.',
