...
const translations = {
  pt: {
    ...
    'projects.invoiceAPI.description': 'A InvoiceAPI é uma API REST para gerenciamento do ciclo completo de faturas em cenários financeiros. O projeto foi desenvolvido com foco em consistência de dados, previsibilidade de cálculos e separação de responsabilidades. Toda a lógica crítica fica centralizada na camada de aplicação/domínio, com cálculo automático de itens e total da fatura, além de uma base preparada para evolução com geração de PDF e novas regras de negócio.',
  ...
  en: {
    ...
    'projects.invoiceAPI.title': 'InvoiceAPI 💸📄',
    'projects.invoiceAPI.description': 'InvoiceAPI is a REST API for full invoice lifecycle management in financial scenarios. It was designed with strong data consistency, predictable calculations, and clear separation of responsibilities. Critical logic is centralized in the application/domain layer, with automatic item and invoice total calculation, plus a foundation ready for future evolution such as PDF generation and additional business rules.',
